				...
				<div class="container">
							...
							if(winloc2!=windowloc){window.location.href = windowloc;}
								...
								<div id="mc_embed_signup">
									...
									<div style="text-align: center;">
											<button class="buttonsub4" id="buttonsub4" onclick="footform();">I have an idea</button>
										</div>
					...
					<div class="row footer-bottom d-flex justify-content-between">
						<p class="col-lg-8 col-sm-12 footer-text m-0 text-white">
							...
							Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by IEC Team
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						</p>
